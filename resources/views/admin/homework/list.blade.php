      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6" style="text-align:right;">
            <a href="{{ url('admin/homework/add')}}" class="btn btn-primary">Add New Homework</a>
          </div>
                      ...
                      <td style="min-width: 140px;">
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ url('admin/homework/edit/'.$value->id) }}">Edit</a>
                            <a class="dropdown-item" href="{{ url('admin/homework/delete/'.$value->id) }}">Delete</a>
                            <a class="dropdown-item " href="{{ url('admin/homework/submitted/'.$value->id) }}">Submitted Homework</a>
                          </div>
                        </div>
                      </td>
                    </tr>
